class Pp1asController < ApplicationController
  ...
  #   </html>
  # }
  # html = %{ http://localhost:3000/pp1s/5 }
  # @pp1a.content = ReverseMarkdown.convert http://localhost:3000/pp1s/5
  @pp1a.content = HtmlMassage.text( html )
